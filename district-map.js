...
function buildDistrictMap(records){
 ...
 document.querySelector('.pulse-legend').innerHTML='<span><i class="dot adopted"></i>Formal rules</span><span><i class="dot emerging"></i>Emerging guidance</span><span><i class="dot none"></i>None found</span><span>○ Not verified</span>';
